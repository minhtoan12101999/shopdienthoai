...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12" style="    display: flex;
    justify-content: left;
    align-items: center; position: relative;">
					<p style="font-size: 15px;">
						<?php
						if (isset($_SESSION["email"])) {
							echo 'Xin Chào' . " " . $_SESSION["email"] . '';
						?>
					</p>
					<div class="thoat" style="position: absolute;
    bottom: 0;
    left: 25%;">
						<a href="dangxuat.php" style="color:#fff">Đăng Xuất</a>
					</div>
				<?php
						}
				?>
				...
				<div id="sidebar" class="col-md-3">
					...
					<div id="banner-l" class="text-center">
						<div class="banner-l-item">
							<a href="#"><img src="./img/banner-l-1.png" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a href="#"><img src="./img/banner-l-2.png" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a href="#"><img src="admin/img/banner-l-3.png" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a href="#"><img src="admin/img/banner-l-4.png" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a href="#"><img src="admin/img/banner-l-5.png" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a href="#"><img src="admin/img/banner-l-6.png" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a href="#"><img src="admin/img/banner-l-7.png" alt="" class="img-thumbnail"></a>
						</div>
					</div>
				</div>
	...
	<footer id="footer">
		<div id="footer-t">
			...
			<div id="footer-b">
				...
				<div id="scroll">
					<a href="#"><img src="admin/img/scroll.png"></a>
				</div>
			</div>
		</div>
	</footer>
